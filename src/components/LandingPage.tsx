...
/**
 * Landing page prototype for the AI xOps by Mainstreet AI business.
  ...
  return (
    <main className="font-sans text-gray-900">
      ...
      <section className="bg-primary text-white py-20 px-6 text-center">
        ...
        <a
          href="#book"
          className="inline-block mt-10 bg-accent text-primary font-semibold px-8 py-4 rounded-2xl shadow-lg hover:scale-105 transition"
        >
      ...
      <section className="bg-gray-50 py-20 px-6 text-center">
        ...
        <div className="relative max-w-4xl mx-auto shadow-2xl rounded-2xl overflow-hidden">
          ...
          <span className="absolute top-4 left-4 bg-white text-gray-800 px-3 py-1 text-xs rounded-full shadow">
            30‑sec demo
          </span>
        </div>
      </section>
      ...
      <section className="bg-primary text-white py-20 px-6 text-center">
        ...
        <div className="max-w-md mx-auto bg-white/10 p-8 rounded-2xl backdrop-blur-lg">
          <label htmlFor="team-size" className="block mb-4 text-lg">
            Team size: {teamSize}
          </label>
          <input
            id="team-size"
      ...
      <section className="py-12 px-6 text-center">
        <p className="text-lg">
          Starts at <span className="font-bold">$15k</span> setup + <span className="font-bold">$2k/mo</span>
        </p>
        <a
          href="#pricing"
          className="inline-block mt-6 bg-accent text-primary font-semibold px-6 py-3 rounded-2xl shadow-md hover:scale-105 transition"
        >
        ...
        <div className="space-y-8">
          <details className="bg-white p-6 rounded-2xl shadow">
            ...
            <p className="mt-4 text-gray-700">
              Most clients start seeing actionable insights within the first week of deployment.
            </p>
          </details>
          <details className="bg-white p-6 rounded-2xl shadow">
            <summary className="font-semibold cursor-pointer">Do we need to change our existing tools?</summary>
            <p className="mt-4 text-gray-700">
              No. We supercharge your current stack (HubSpot, Notion, Zapier, etc.).
            </p>
          </details>
          <details className="bg-white p-6 rounded-2xl shadow">
            <summary className="font-semibold cursor-pointer">Is our data secure?</summary>
            <p className="mt-4 text-gray-700">
              All automations run within your environment; you maintain full control of your data.
            </p>
          </details>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-primary text-white py-12 px-6 text-center space-y-4">
        <h4 className="text-xl font-bold">Ready to compound every conversation?</h4>
        <a
          href="#book"
          className="inline-block bg-accent text-primary font-semibold px-8 py-4 rounded-2xl shadow-lg hover:scale-105 transition"
        >
          Book a 30‑Minute AI Ops Audit
        </a>
